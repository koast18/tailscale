...
// Package pins holds the types for locally-pinned favorites (devices, exit nodes, and services).
// They're shared by the pinning feature and the LocalAPI client.
package pins
...
// synced across a user's devices, and stored under the "pinning" feature for the current profile.
type Set struct {
